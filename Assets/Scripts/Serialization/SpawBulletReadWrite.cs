...
{
    public static void WriteSpawBulletTransform(this Writer writer, SpawBulletTransform value)
    {
    ...
    public static SpawBulletTransform ReadSpawBulletTransform(this Reader reader)
    {
